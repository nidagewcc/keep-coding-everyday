 ...
 * todo 还没搞懂
 * 1. 用这么多位运算做什么？
 * 2. 机器id、数据标识id、序列id，还有偏移量啥的这些设置这些啥意思？最后拼接起来？
 *
 * 还有雪花算法的优缺点？
 *
 */
public class SnowFlakeIdGenerator {
    ...
    public synchronized long nextId() {
        ...
        System.out.println((timestamp - INITIAL_TIME_STAMP) << TIMESTAMP_OFFSET);
        System.out.println(datacenterId << DATACENTERID_OFFSET);
        System.out.println(workerId << WORKERID_OFFSET);
